...
<section id="all">
	...
	<div>
		<form action="/admin/olSearch">
			...
			<button class="btn btn-outline-secondary my-2 my-sm-0" onclick="javascript:window.location = '/admin/orderListAdmin'">검색 초기화</button>
		</form>
		<p>
	...
	<div>
		...
		<form id="stateChangeTotalList">
			<select name="status" id='serch' class="nav-link dropdown-toggle" style="float: left;">
			...
			<button class="btn btn-outline-secondary my-2 my-sm-0" onclick="submit_state()" >변경</button>
		</form>
	</div>
</section>
</body>
