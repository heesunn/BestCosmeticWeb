	...
	<div>
	    ...
	    <c:forEach items="${inTransit}" var="transit">
		        <tr>
		            ...
		            <td><a href="#" 
		            	onclick="javascript:window.open('http://localhost:8081/member/orderDetail?bco_ordernum=${transit.bco_ordernum}', 
		            	'주문내역 상세', 'width=400, height=300')">${transit.bco_order_name}</a>
		            </td>
		        </tr>
		        <script>
