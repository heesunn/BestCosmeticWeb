	...
	<div>
	    ...
	    <c:forEach items="${deliveryCompleted}" var="completed">
		        <tr>
		            ...
		            <td><a href="#" 
		            	onclick="javascript:window.open('http://localhost:8081/member/orderDetail?bco_ordernum=${completed.bco_ordernum}', 
		            	'주문내역 상세', 'width=400, height=300')">${completed.bco_order_name}</a>
		            </td>
		        </tr>
		        <script>
